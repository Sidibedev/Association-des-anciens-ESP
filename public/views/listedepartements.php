...
<div class="container-fluid mimin-wrapper">
    ...
    <div id="content" class="moncontent">
        ...
        <div class="container">
            ...
            <h2 class="block" align="center">LISTE DES DEPARTEMENTS </h2>
            ...
            <table class="table  table-bordered">
                ...
                <?php
                 if($departements == null) {
                    ...
                    echo "<h3 class=text-danger >Vous navez aucun departement , ajoutez des departements </h3>";;
                }else foreach($departements as $depart) { ?>

                <tr>



                    <td > <?php echo $depart->codedepartement; ?> </td>
                    <td ><?php echo $depart->nom; ?> </td>




                    <td ><a href="../../app/controllers/DepartementController.php?modifier=<?php echo $depart->codedepartement ; ?>" class="btn btn-success" role="button" name="modifier"><span>
                	<i class="fa fa-refresh"></i>


                                <form action="../../app/controllers/DepartementController.php" method="post">




                                    <!--                                <td ><a href="../../app/controllers/FormationController.php?code= --><!--" class="btn btn-danger" role="button" name="supprimer"><span>-->
                                    <td ><a href="../../app/controllers/DepartementController.php?code=<?php echo $depart->codedepartement ; ?>" class="btn btn-danger" role="button" name="supprimer"><i class="fa fa-remove"></i><span>
