...
<div class="container-fluid mimin-wrapper">
    ...
    <div id="content" class="moncontent">
        ...
        <div class="container">
            ...
            <h2 class="block" align="center">LISTE DES NIVEAUX .</h2>
            ...
            <table class="table  table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-success">Intitule</th>
                ...
                <?php if($niveaux == null) {
                    ...
                    echo "<h3 class=text-danger >Vous navez aucun niveau , ajoutez des niveaux  </h3>";
                }else foreach($niveaux as $niv) { ?>

                <tr>



                    <td > <?php echo $niv->intitule; ?> </td>





                    <td ><a href="../../app/controllers/NiveauController.php?modifier=<?php echo $niv->intitule ; ?>" class="btn btn-success" role="button" name="modifier"><span>
                	<i class="fa fa-refresh"></i>
                                ...
                                <form action="../../app/controllers/DepartementController.php" method="post">
                                    ...
                                    <td ><a href="../../app/controllers/NiveauController.php?code=<?php echo $niv->intitule ; ?>" class="btn btn-danger" role="button" name="supprimer"><i class="fa fa-remove"></i><span>
