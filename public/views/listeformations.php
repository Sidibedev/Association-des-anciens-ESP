...
require "../../app/controllers/FormationController.php";
...
<div class="container-fluid mimin-wrapper">
    ...
    <div id="content" class="moncontent">
        ...
        <div class="container">
            ...
            <h2 class="block" align="center">LISTE DES FORMATIONS </h2>
            ...
            <table class="table  table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-success">Libelle</th>

                    <th class="text-success">Departement</th>
                    <th class="text-success">Niveau</th>
                ...
                <?php if($formations == null) {
                    ...
                    echo "<h3 class=text-danger >Vous navez aucune formation , ajoutez des formatons </h3>";
                }else  foreach($formations as $formation) { ?>
                ...
                <tr>
                    ...
                    <td ><?php echo $formation->libelle; ?> </td>
                    <td ><?php echo $formation->departement; ?> </td>
                    <td><?php echo $formation->niveau; ?> </td>



                    <td ><a href="../../app/controllers/FormationController.php?modifier=<?php echo $formation->code ; ?>" class="btn btn-success" role="button" name="modifier"><span>
                	<i class="fa fa-refresh"></i>
                                ...
                                <td ><a href="../../app/controllers/FormationController.php?code=<?php echo $formation->code ; ?>" class="btn btn-danger" role="button" name="supprimer"><i class="fa fa-remove"></i><span>
