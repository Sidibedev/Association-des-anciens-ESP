...
<div class="container-fluid mimin-wrapper">
    ...
    <div id="content" class="moncontent">
        ...
        <div class="container">
            ...
            ?>
            <h2 class="block" align="center">Modifier un niveau.</h2>

            <form method="post" action="../../app/controllers/NiveauController.php">
                <div class="form-group">
                    <label for="exampleTextarea">Nouvel Intitule</label>
                    <input value="<?php if(isset($_GET['nivintitule'])) echo $_GET['nivintitule']?>"  class="form-control" name="nlib" rows="3" placeholder="DUT1"></input>
                </div>


                <input name="anciencode" type="hidden" value="<?php if(isset($_GET['nivintitule'])) echo $_GET['nivintitule']?>">
                ...
                <div>
                    ...
                    <button type="submit" class="boutton" name="modifierniveau">Modifier Niveau</button>
            ...
            <h2 class="block" align="center">Ajoutez un niveau.</h2>


            <?php

            if (isset($_GET['success'])){
                echo "<h3 class=text-success>Votre niveau a bien été ajouté</h3>";
            }
            ...
            <form method="post" action="../../app/controllers/NiveauController.php">
                <div class="form-group">
                    <label for="exampleTextarea">Intitule</label>
                    <input class="form-control" name="lib" rows="3" placeholder="DUT1"></input>
                </div>
                ...
                <div>
                    ...
                    <button type="submit" class="boutton" name="ajouterniveau">Ajouter Niveau</button>
